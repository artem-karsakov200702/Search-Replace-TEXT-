...
Разработать консольное приложение на языке C++ для поиска и замены
текста в JSON-файлах.\
Программа выполняет:
...
**Цель работы** --- освоить работу с JSON в C++, алгоритмы поиска
подстрок, замену текста, обработку больших объемов данных и измерение
производительности.
...
-   Структура JSON: массив объектов \[{\"name\": \"string\",
    \"content\": \"string\"}, \...\]

-   Обязательные поля: name (строка), content (строка)

-   Допустимые ошибки: пустые name, отсутствующие поля, некорректный
    JSON
...
-   replaceAllOccurrences() --- эффективная замена с резервированием
    памяти
...
**Входные данные:** JSON-массив объектов \[{\"name\": \"file.txt\",
\"content\": \"текст\"}, \...\]
